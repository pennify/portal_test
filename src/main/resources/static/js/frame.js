...
(function () {
    ...
    var data = [
        ...
        },
        {
            ...
            children:[
                ...
                {id:'005',level:2, icon:'',title:'轮播图片',path:'/portal_test/portal/sliderView',children:[]},
                {id:'006',level:2, icon:'',title:'优惠列表',path:'/portal_test/portal/listView',children:[]},
                {id:'007',level:2, icon:'',title:'公司简介',path:'/portal_test/portal/listView',children:[]},
                {id:'008',level:2, icon:'',title:'附件管理',path:'page2.jsp',children:[]},
                {id:'009',level:2, icon:'',title:'作废审批',path:'page3.jsp',children:[]},
                {id:'010',level:2, icon:'',title:'岗位说明书管理',path:'sliderView.jsp',children:[]}
            ]
        },
        {
            id:'011',
            ...
            level:1,
            children:[
                {id:'012',level:2,icon:'',title:'资源管理',path:'sliderView.jsp',children:[]},
                {id:'013',level:2,icon:'',title:'角色管理',path:'sliderView.jsp',children:[]},
                {id:'014',level:2,icon:'',title:'用户管理',path:'sliderView.jsp',children:[]},
                {id:'015',level:2,icon:'',title:'组织机构',path:'sliderView.jsp',children:[]}
            ]
        },
        {
            id:'016',
            ...
            level:1,
            children:[
                {id:'017',level:2,icon:'',title:'资源管理',path:'sliderView.jsp',children:[]},
                {id:'018',level:2,icon:'',title:'角色管理',path:'sliderView.jsp',children:[]},
                {id:'019',level:2,icon:'',title:'用户管理',path:'sliderView.jsp',children:[]},
                {id:'020',level:2,icon:'',title:'组织机构',path:'sliderView.jsp',children:[]}
            ]
        },
        {
            id:'021',
            ...
            level:1,
            children:[
                {id:'022',level:2,icon:'',title:'数据字典管理',path:'sliderView.jsp',children:[]}
            ]
        },
        {
            id:'023',
            ...
            level:1,
            children:[
                {id:'024',level:2,icon:'',title:'SD图管理',path:'sliderView.jsp',children:[]},
                {id:'025',level:2,icon:'',title:'SD图审核及记录',path:'sliderView.jsp',children:[]},
                {id:'026',level:2,icon:'',title:'SD图延迟预警',path:'sliderView.jsp',children:[]},
                {id:'027',level:2,icon:'',title:'SD图操作日志',path:'sliderView.jsp',children:[]}
            ]
        },
        {
            id:'028',
            ...
            level:1,
            children:[
                {id:'029',level:2,icon:'',title:'SD图管理',path:'sliderView.jsp',children:[
                    {id:'030',level:3,icon:'',title:'SD图一',path:'sliderView.jsp',children:[]},
                    {id:'031',level:3,icon:'',title:'SD图二',path:'sliderView.jsp',children:[]},
                    {id:'032',level:3,icon:'',title:'SD图三',path:'sliderView.jsp',children:[]}
                ]},
                {id:'033',level:2,icon:'',title:'SD图审核及记录',path:'sliderView.jsp',children:[]},
                {id:'034',level:2,icon:'',title:'SD图延迟预警',path:'sliderView.jsp',children:[]},
                {id:'035',level:2,icon:'',title:'SD图操作日志',path:'sliderView.jsp',children:[]}
            ]
        }
    ];
    ...
    function createTabPage (id , path) {
        var page = $("<iframe class='mypage' src='"+path+"' id='page"+id+"' ></iframe>");
        if(currPage != null) {
